...
// COMMENTLEVEL 1 — Movie Detective
SELECT *
FROM movies
WHERE rating > 8;
SELECT *
...
// COMMENTLEVEL 2 — Streaming Recommendation Team
SELECT *
FROM movies
ORDER BY views DESC
LIMIT 5;
...
FROM movies;
SELECT title, director, production_company
FROM movies;
SELECT *
FROM movies
...
ORDER BY price DESC
LIMIT 5;
// COMMENTLEVEL 3 — Find the Hidden Movies     
SELECT *
FROM movies
WHERE title LIKE 'A%';
SELECT *
...
FROM movies
WHERE director <> 'S. S. Rajamouli';
// COMMENTLEVEL 5 — Boss Challenges
SELECT *
FROM movies
WHERE rating > 8
AND views < 500000;
